 ...
 * @author Naro
 */
@WebServlet(name = "TagListServlet", urlPatterns = {"/TagListServlet"})
public class TagListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TagListServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TagListServlet at " + request.getContextPath() + "</h1>");
