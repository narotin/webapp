        ...
        <div id="pagebody">
            ...
            <div id="ranking">
                ...
                <ul class="ranking-buttom">
                    <li id="ranking-buttom1"><a href="./RankingServlet?rankingType=1">キラキラでないが多い順</a></li>
                    <li id="ranking-buttom2"><a href="./RankingServlet?rankingType=2">どちらともいえないが多い順</a></li>
                    <li id="ranking-buttom3"><a href="./RankingServlet?rankingType=3">キラキラであるが多い順</a></li>
                </ul>
                <ul class="ranking-buttom">
                    <li id="ranking-buttom4"><a href="./RankingServlet?rankingType=4">投票数が多い順</a></li>
                    <li id="ranking-buttom5"><a href="./RankingServlet?rankingType=5">コメント数が多い順</a></li>
                    <li id="ranking-buttom6"><a href="./RankingServlet?rankingType=6">投稿日が新しい順</a></li>
                </ul>
            </div>
